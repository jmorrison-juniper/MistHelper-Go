...
// TestRun_ValidOptionWithCRNULThenEOF verifies that CR-NUL Enter sequences work in Run.
// This mirrors PTY clients that emit NUL after carriage return for Enter.
func TestRun_ValidOptionWithCRNULThenEOF(t *testing.T) {
	t.Parallel() // Safe to run concurrently
